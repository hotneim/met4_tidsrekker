...
**2. Analyse av global temperatur.** La oss når ta for oss eksempelet fra videoen der vi ser på den globale månendlige gjennomsnittstemperaturen fra 1880 til 2016. Last ned `temp.csv` som ligger på denne modulen, og som er en CSV-fil som inneholder datasettet. Se på de første par radene:
...
- **Bonuspoeng 1:** Bruk datokolonnen i det opprinnelige datasettet til å få datoer på $x$-aksen.
- **Bonuspoeng 2:** Husk at vi nå har predikert *forandringen* i den globale gjennomsnittstemperaturen fra måned til måned. Kan du heller lage en figur med selve temperaturserien og bruke prediksjonene dine til å heller plotte inn de tilhørende predikerte temperaturene?
